...
String buildHTML() {
  ...
  html = "<!DOCTYPE html><html lang='de'><head>"
    ...
    ".rk{color:#333;width:22px}.nm{color:#aaa;max-width:90px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.dt{color:#555}"
    ...
    "</style></head><body>"
    "<h1>&#9201; MTB SPLIT <span id='_ld' class='ld on'></span></h1>";
